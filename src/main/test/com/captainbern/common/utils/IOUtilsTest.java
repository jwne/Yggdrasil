...
public class IOUtilsTest {
    ...
    public void letsTestApacheAndBern() {
        try {
            ...
            int lengthWithBern = com.captainbern.common.utils.IOUtils.toByteArray(ClassLoader.getSystemResourceAsStream(IOUtilsTest.class.getName().replace('.', '/') + ".class")).length;
