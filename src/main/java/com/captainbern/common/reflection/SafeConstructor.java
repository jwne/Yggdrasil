...
import com.captainbern.common.internal.CommonPlugin;
...
public class SafeConstructor<T> {
    ...
    public SafeConstructor(Class<?> coreClass, Class<?>... params){
        try {
            ...
            CommonPlugin.LOGGER_REFLECTION.log(Level.WARNING, "No such constructor! (className= {0})", coreClass.getSimpleName());
        }
    }
